...
const handlerPos = src.indexOf("veil.on('stt:interim'");
...
const finalHandlerPos = src.indexOf("veil.on('stt:final'");
...
const llmStartIdx = src.indexOf("veil.on('llm:start'");
const llmTokenIdx = src.indexOf("veil.on('llm:token'");
